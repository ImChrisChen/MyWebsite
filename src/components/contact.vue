                    ...
                    <section>
                        ...
                        <div class="primary-content">
                            ...
                            <p class="lead">Lorem ipsum Deserunt est dolore Ut Excepteur nulla occaecat magna occaecat
                                Excepteur nisi esse veniam dolor consectetur minim qui nisi esse deserunt commodo ea
                                enim ullamco non voluptate consectetur minim aliquip Ut incididunt amet ut
                                cupidatat.</p>
                                ...
                                <fieldset>
                                    ...
                                    <div class="message form-field">
                                        <textarea name="cMessage" id="cMessage" class="full-width"
                                                  placeholder="Your Message" v-model="content"></textarea>
                                    </div>

                                    <button @click="bindSendMessage"
                                            class="submit button-primary full-width-on-mobile">Submit
                                    </button>
